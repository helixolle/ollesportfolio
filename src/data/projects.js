...
export const projects = {
  ...
  'ar-navigation': {
    ...
    coverImage: 'src/assets/images/thumbs/arnavigation_omslag.png',
    ...
    sections: [
      ...
      },
      {
        ...
        images: ['src/assets/images/ar-navigation/req_table.png']
      },
      {
        type: 'process',
        ...
        images: ['src/assets/images/ar-navigation/sketches.png', 'src/assets/images/ar-navigation/wireframe.png', 'src/assets/images/ar-navigation/mockup.png']
      },
      {
        type: 'solution',
        title: 'AR Prototype',
  ...
  'origin-story': {
    ...
    coverImage: 'src/assets/images/thumbs/OS_omslag.png',
    heroImage: 'src/assets/images/thumbs/OS_omslag.png',
    ...
    sections: [
      ...
      },
      {
        ...
        images: ['src/assets/images/originstory/Brainstorm_users.png']
      },
      {
        type: 'discovery',
        title: 'Target Group',
      ...
      },
      {
        ...
        images: ['src/assets/images/originstory/skisser.png']
      },
      {
        type: 'approach',
        title: 'Wireframes',
      ...
      },
      {
        ...
        images: ['src/assets/images/originstory/interactive1.png', 'src/assets/images/originstory/interactive2.png', 'src/assets/images/originstory/interactive3.png']
      },
      {
        type: 'solution',
        ...
        images: ['src/assets/images/originstory/animatedtrans.gif', 'src/assets/images/originstory/spinners.gif']
      },
      {
        type: 'approach',
        title: 'Aesthetics',
      ...
      },
      {
        ...
        images: ['src/assets/images/originstory/Logo.png']
      },
      {
        type: 'conclusion',
  ...
  '2gether-2-0': {
    ...
    coverImage: 'src/assets/images/thumbs/2gether_omslag.png',
    heroImage: null,
...
Through persona development, I identified three key user scenarios that would drive the app's functionality and user experience.`,
        ...
        images: ['src/assets/images/2gether/persona.png']
      },
      {
        type: 'approach',
...
These scenarios guided every design decision, from information architecture to interaction patterns.`,
        images: ['src/assets/images/2gether/scenario.png']
      },
      {
        type: 'process',
        title: 'Design Process',
...
Each stage built upon insights from the previous, ensuring the final design was both user-centered and technically feasible.`,
        images: ['src/assets/images/2gether/sketches.png', 'src/assets/images/2gether/Paper_prototype.png']
      },
      {
        type: 'solution',
...
- **Profile Page** - Personal dashboard for creators`,
        images: ['src/assets/images/2gether/wireframes.png', 'src/assets/images/2gether/mockup.png']
      },
      {
        type: 'solution',
        title: 'Interactive Prototype',
...
The result prioritizes **usability, accessibility, and community** - exactly what digital creators need to thrive in today's competitive landscape. This project demonstrates how thoughtful UX design can address real creator economy challenges while building sustainable, user-centered solutions.`
  ...
  'aquatik': {
    ...
    coverImage: 'src/assets/images/thumbs/aquatik_omslag.png',
    heroImage: null,
...
We developed **detailed personas** representing different types of pet owners, each with unique needs and contexts for using Aquatik. We then created scenarios and storyboards to understand how users would interact with Aquatik in real-world contexts.`,
        ...
        images: ['src/assets/images/aquatik/personanicole.png', 'src/assets/images/aquatik/personaoscar.png', 'src/assets/images/aquatik/storyboard.png']
      },
      {
        type: 'approach',
...
**Key finding:** Respondents unanimously wanted **a system combining a physical product and an app** connected to the physical device. This insight became the foundation of our design approach.`,
        images: ['src/assets/images/aquatik/req_list.png']
      },
...
This approach ensured diverse perspectives while maintaining design consistency.`,
        images: ['src/assets/images/aquatik/1registrera.png', 'src/assets/images/aquatik/2startsida.png', 'src/assets/images/aquatik/3halsosidan.png']
      },
      {
        type: 'solution',
...
The final step was creating a **fully interactive prototype** with realistic transitions and micro-interactions, essential for comprehensive usability testing and stakeholder validation.`,
        images: ['src/assets/images/aquatik/wireframes.png', 'src/assets/images/aquatik/mockup.png']
      },
...
The final design balances **aesthetic appeal with functional sensor integration**, ensuring accurate water level monitoring while maintaining an attractive appearance for home environments.`,
        images: ['src/assets/images/aquatik/sketches_physical.png', 'src/assets/images/aquatik/StudioBlue.png', 'src/assets/images/aquatik/StudioWhite.png', 'src/assets/images/aquatik/StudioWood.png']
      },
...
This project showcased the importance of **user-centered design processes** and demonstrated how **collaborative teamwork** can produce comprehensive solutions for emerging IoT markets.`
  ...
  coverImage: 'src/assets/images/thumbs/heli_omslag.png',
  heroImage: 'src/assets/images/thumbs/heli_omslag.png',
...
'hallbart-professionell': {
  ...
  heroImage: '/src/assets/images/thumbs/hallbart_omslag.png',
...
'screen-replacement': {
  ...
  coverImage: null,
  heroImage: 'src/assets/images/thumbs/screen_omslag.png',
